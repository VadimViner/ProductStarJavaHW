...
public class TestCircle {
    ...
    private void testCalculateAreaCorrectly(){
        Circle circle = new Circle(2, 5);
       if (compareDouble(circle.getArea(), Math.PI * circle.getRadius() * circle.getRadius())){
           System.out.println("testCalculateAreaCorrectly: OK");
       } else {
           System.out.println("testCalculateAreaCorrectly: FAILURE");
       }
    }
    ...
    private void testNegativeRadiusShouldFail() {
        try {
            Circle circle = new Circle(-2, 12.56);
            System.out.println("testNegativeRadiusShouldFail: FAILURE");
        } catch (Error e) {
            System.out.println("testNegativeRadiusShouldFail: OK — caught expected error: " + e.getMessage());
        }
    }
    ...
    public void test() {
        ...
        testSetRadius();
        testGetArea();
        testCalculateAreaCorrectly();
        testRadiusIsPositive();
        testNegativeRadiusShouldFail();
